...
ALL_TEMPLATES_TO_DUPLICATE = DEFAULT_TEMPLATES_TO_DUPLICATE + SCANNER_TEMPLATES_TO_DUPLICATE
...
def duplicate_default_templates_for_tenant(
    ...
    des templates Consolidé, Individuel et Scanner qu'il pourra personnaliser.
    ...
    templates_to_duplicate = ALL_TEMPLATES_TO_DUPLICATE if include_scanner else DEFAULT_TEMPLATES_TO_DUPLICATE
