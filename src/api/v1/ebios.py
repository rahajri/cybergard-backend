...
def update_workshop_progress(db: Session, project_id: str, workshop_type: str = None):
    ...
    - AT5: 100% si matrice générée (snapshot existe)
    """
    try:
        ...
        # AT5: 100% si snapshot matrice existe
        progressions['AT5'] = 100 if counts.matrix_snapshots > 0 else 0
...
async def get_project_actions(
    ...
    try:
        ...
        for i, action in enumerate(actions_list):
            ...
            # Récupérer l'ID utilisateur assigné (null par défaut pour actions IA)
